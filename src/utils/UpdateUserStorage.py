...
def sync_update_user_storage_in_db(db_session: Session, total_image_size: int, user_id: str, module: str, increment: bool = True):
    """
    ...
    :param increment: Whether to increase (True) or decrease (False) the storage.
    ...
    try:
        if module == settings.APP_SMART_CULL_MODULE:
            ...
            return False, {'message': 'failed', 'detail': 'No module with this name'}
