"""updated smart share folder model removed upload_in_progress and uploading_task_ids

Revision ID: 0a24e2682db8
Revises: eecc3c2e135e
Create Date: 2025-04-28 11:27:41.147856
...
revision: str = '0a24e2682db8'
down_revision: Union[str, None] = 'eecc3c2e135e'
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('smart_share_folders', sa.Column('uploading_task_id', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('smart_share_folders', sa.Column('uploading_in_progress', sa.BOOLEAN(), autoincrement=False, nullable=False))
